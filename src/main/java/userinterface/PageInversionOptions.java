...
public class PageInversionOptions {
    ...
    public static final Target ARROW = Target.the("The arrow").located(By.id("mostrar-filtros"));
    ...
    public static Target findMonto(String tipoInversion){
        return Target.the("type investment").located(By.xpath("//ul[contains(@class, 'productos-filtro_tags--desktop')]/li/a[contains(.,'"+tipoInversion+"')]"));
    }
}
